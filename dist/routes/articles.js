 ...
 */
router.post('/', (0, middleware_1.asyncHandler)(articleController.createArticle.bind(articleController)));
/**
 * @swagger
 * /articles:
 *   get:
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.get('/', (0, middleware_1.asyncHandler)(articleController.getArticles.bind(articleController)));
/**
 * @swagger
 * /articles/stats:
 *   get:
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.get('/stats', (0, middleware_1.asyncHandler)(articleController.getArticleStats.bind(articleController)));
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.get('/providers/status', (0, middleware_1.asyncHandler)(articleController.getProviderStatus.bind(articleController)));
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.post('/bulk/regenerate-summaries', (0, middleware_1.asyncHandler)(articleController.bulkRegenerateSummaries.bind(articleController)));
/**
 * @swagger
 * /articles/tags/{tags}:
 *   get:
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.get('/tags/:tags', (0, middleware_1.asyncHandler)(articleController.getArticlesByTags.bind(articleController)));
/**
 * @swagger
 * /articles/{id}:
 *   put:
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.put('/:id', (0, middleware_1.asyncHandler)(articleController.updateArticle.bind(articleController)));
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.post('/:id/summary/regenerate', (0, middleware_1.asyncHandler)(articleController.regenerateSummary.bind(articleController)));
/**
 * @swagger
 * /articles/{id}:
 *   get:
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.get('/:id', (0, middleware_1.asyncHandler)(articleController.getArticleById.bind(articleController)));
/**
 * @swagger
 * /articles/{id}:
 *   delete:
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.delete('/:id', (0, middleware_1.asyncHandler)(articleController.deleteArticle.bind(articleController)));
